    ...
    if (!window.KAMPYLE_EMBED) {
        window.KAMPYLE_EMBED = {
            ...
            isSupported: function () {
                var result = { isIE: false, trueVersion: 0, actingVersion: 0, compatibilityMode: false };
            ...
            getGenericLocation: function () {
                var genericLocation = location.protocol + "//" + "nebula-cdn.kampyle.com/we/71178/onsite/generic1582205516550.js";
...
function Bubbles(container, self, options) {
    ...
    var addBubble = function(say, posted, reply, live) {
        ...
        if (reply !== "") {
            ...
            let currentBubbles = document.querySelectorAll(".bubble-button");
            currentBubbles.forEach((x) => {
                x.addEventListener("click", (s) => {
                    s.currentTarget.classList.add("bubble-pick")
                })
...
function processResponse(data) {
    ...
    console.log('RETURNED', returnedMessage.messages.message);
    ...
    console.log('CALL-OUT BUTTONS', calloutButtons);
    ...
    console.log('BEFORE', quickReplies);
    ...
    console.log('AFTER', quickReplies);
        ...
        var match = function (key) {
            ...
            if (destination === 'bot') {
                $.post("/messages", {
                    ...
                    .done((data) => {
                        console.log("First OTHER PROCESSING");
                        if (!convoClosed) {
                            processResponse(data)
                        } else {
                            alert("This conversation is expired. Please refresh to restart");
...
$('body').on('click', 'span.bubble-button', function () {
    ...
    if (destination === 'bot') {
        $.post("/messages", {
            ...
            .done((data) => {
                console.log("First 3RD PROCESSING");
                if (!convoClosed) {
                    processResponse(data)
                } else {
                    alert("This conversation is expired. Please refresh to restart");
